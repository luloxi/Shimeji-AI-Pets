        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <p className="text-xs text-muted-foreground">
              {isSpanish
                ? "Si el usuario de X está vacío, el feedback es anónimo y no participa del giveaway. Recuerda seguir a @shimejidev en X."
                : "If X username is empty, feedback is anonymous and not eligible for the giveaway draw. Also remember to follow @shimejidev on X."}
            </p>
            <Button
              type="submit"
